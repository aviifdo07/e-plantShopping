...
function ProductList({ onHomeClick }) {
    ...
    const [showPlants, setShowPlants] = useState(true); // Added this missing state
    ...
    const totalQuantity = cartItems.reduce((sum, item) => sum + item.quantity, 0); // Total items count
                            ...
                            <div className="plant-section">
                                {section.plants.map((plant, plantIndex) => (
                                    <div key={plantIndex} className="product-card">
                                        ...
                                        <p><strong>Price: {plant.cost}</strong></p>
                                        <button 
